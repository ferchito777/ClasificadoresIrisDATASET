"""
¿Cómo funciona GaussianNB?
GaussianNB es un clasificador basado en el teorema de Bayes, que asume que las características siguen una distribución normal (gaussiana) dentro de cada clase.
Calcula la probabilidad de que una muestra pertenezca a cada clase y asigna la clase con mayor probabilidad.
Es rápido, sencillo y funciona bien cuando los datos realmente tienen una distribución aproximadamente normal.
"""
import numpy as np
...
print("="*50)
print("MÉTRICAS DEL CLASIFICADOR GaussianNB")
print("="*50)
...
fig.suptitle('Clasificador GaussianNB - Dataset Iris', fontsize=16, fontweight='bold')
