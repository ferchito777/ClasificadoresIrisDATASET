"""
¿Cómo funciona MLPClassifier?
MLPClassifier (Perceptrón Multicapa) es un clasificador basado en redes neuronales artificiales. Utiliza capas de neuronas (mínimo una oculta) que aprenden representaciones no lineales de los datos mediante el ajuste de pesos usando retropropagación.
Es capaz de modelar relaciones complejas y no lineales, y se utiliza para clasificación supervisada. Los hiperparámetros principales son el número de capas, neuronas por capa, función de activación y el algoritmo de optimización.
"""
import numpy as np
...
# Crear y entrenar el clasificador MLPClassifier
...
print("="*50)
print("MÉTRICAS DEL CLASIFICADOR MLPClassifier")
print("="*50)
...
fig.suptitle('Clasificador MLP (Red Neuronal) - Dataset Iris', fontsize=16, fontweight='bold')
